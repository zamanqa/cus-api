...
// Table: public.debtist_claims

// Get a debtist claim for beforeEach (provides claim_id, invoice_ids, customer_id)
...
// Get an eligible invoice for filing a debtist claim (Test 4)
// Must be unpaid, no existing claim, with a transaction that has invoice_number
...
// Set invoice + transaction dates to now - 3 days and transaction status to 'failed' (Test 4 setup)
...
// Verify claim was created for invoice in debtist_claims table
